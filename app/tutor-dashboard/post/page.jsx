...
function CommentInput({ initialComments = [] }) {
  ...
  function handleSend() {
    ...
    setComments((prev) => [
      { id: Date.now(), name: "You", initials: "RK", text: comment.trim(), time: "just now" },
      ...prev,
    ]);
    setComment("");
  }
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {post.mentorCount && <MentorBadge />}
            {post.role && (
              <span className="text-white bg-purple-600 py-1 px-3 rounded-full text-xs">{post.role}</span>
            )}
          </div>
    ...
    <div className="bg-[#f2f3fa] rounded-2xl shadow-sm border border-gray-100 overflow-hidden w-full">
      ...
      <div className="bg-white flex">
        <div className="flex-1 px-5 pb-4 flex flex-col gap-3">
          <img src={post.image.src} alt="post" className="w-full h-90 object-cover rounded-xl" />
          <div className="flex items-center gap-2 flex-wrap">
      ...
      <div className="bg-white flex">
        <div className="flex-1 px-5 pb-4 flex flex-col gap-3">
          <div className="relative w-full h-90 rounded-xl overflow-hidden">
            <img src={post.videoThumb} alt="video thumbnail" className="w-full h-full object-cover" />
...
export default function PostPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 flex flex-col gap-6">
      <h1 className="text-2xl font-black text-slate-800 mb-2">Tutor Posts</h1>
