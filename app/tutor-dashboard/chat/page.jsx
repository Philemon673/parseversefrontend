...
import {
  ...
  MoreVertical, ImageIcon, ChevronUp, ChevronDown,
} from "lucide-react";
            ...
            {matches.length > 1 && (
              <div className="flex items-center gap-0.5">
                <button
                  ...
                  className="w-6 h-6 rounded-lg bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-500 transition"
                >
            ...
            <div className="bg-white border border-slate-100 rounded-xl shadow-sm overflow-hidden">
              <div className="flex items-center justify-between px-3 py-1.5 border-b border-slate-50">
                <span className="text-[10px] text-slate-400 font-medium">
                  {matches.length} message{matches.length !== 1 ? "s" : ""} found
                </span>
              </div>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 transition ${
                        i === matchIndex ? "bg-indigo-50" : "hover:bg-slate-50"
                      }`}
                    >
