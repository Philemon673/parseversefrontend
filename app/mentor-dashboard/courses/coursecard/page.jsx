        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-100">
          ...
          <div className="flex items-center gap-2">
            ...
            {course.type === "Hardcopy" ? (
              <NextLink
                href={`/mentor-dashboard/courses/hardcopy?courseId=${course.id}&status=${course.status}`}
              ...
              <NextLink
                href={`/mentor-dashboard/courses/coursedetails?courseId=${course.id}&status=${course.status}`}
                className="px-3 py-1.5 rounded-xl bg-indigo-600 text-white text-xs font-semibold hover:bg-indigo-700 transition flex items-center gap-1"
              >
                <Play className="w-3 h-3" />
                Preview
